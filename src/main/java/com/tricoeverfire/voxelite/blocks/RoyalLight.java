...
public class RoyalLight extends Block {
	
	
	private static boolean needsTransparency = false;
	
	public RoyalLight(String name,Number num,Material material, boolean unbreaking, boolean transparent) {
	...
	public RoyalLight(String name, Material material, boolean unbreaking, boolean transparent) {
		this(name,8,material,unbreaking, transparent);
		
		
	}
	
	public RoyalLight(String name, Material material, boolean unbreakable) {
		this(name, 8, material, unbreakable,false);
		
	}


	public RoyalLight(String name,Material material) {
